...
repos = ["apache/logging-log4j2","ReactiveX/RxJava","apache/cassandra","apache/camel","apache/hive","apache/commons-lang"]

def getJMH():
    jmh = {}
    for repo in repos:
        repo_url = 'https://api.github.com/search/code?q=org.openjdk.jmh+in:file+language:java+repo:%s&page=1' % repo  # 确定url
